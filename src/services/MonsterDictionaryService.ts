...
const MONSTER_DATA: Record<string, MonsterData> = {
  "decayed-skeleton": {
    ...
    preview: "assets/outfit-preview/skeleton-outfit-preview.png",
    health: 8,
    maxHealth: 8,
    speed: 50,
    experience: 40000,
    ...
    drops: [
      ...
      { itemId: "boneShield", chance: 0.05 },
      { itemId: "shinySkull", chance: 0.45, minQuantity: 1, maxQuantity: 1 },
      { itemId: "goldCoins", chance: 0.95, minQuantity: 500000, maxQuantity: 800000000 },
    ],
    isAggressive: true,
